...
- Before: 다음 페이지 fetch 에러 -> Promise Reject -> Error Boundary (화면 먹통)
  <img src="/content-image/open-source/tanstackquery/useInfiniteQuery_before.gif" alt="설명" class="block w-full desktop:w-[50%] mx-auto" />
- After: 다음 페이지 fetch 에러 -> 데이터 유무 확인 -> 데이터 있음 확인 -> Promise Resolve -> 기존 UI 유지 + 에러 상태값 전달
  <img src="/content-image/open-source/tanstackquery/useInfiniteQuery_after.gif" alt="설명" class="block w-full desktop:w-[50%] mx-auto" />
