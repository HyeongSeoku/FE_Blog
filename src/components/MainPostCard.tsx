    ...
    <article className={classNames(cardBaseClass, "h-full")}>
      <Link href={link} className="flex h-full flex-col">
        ...
        <div className="flex flex-1 flex-col p-5 bg-white dark:bg-transparent">
          {categoryLabel && (
            <span className="text-[10px] font-bold tracking-widest uppercase text-gray-600 dark:text-gray-400 mb-2">
              {categoryLabel}
            </span>
          )}
    ...
    return (
      <>
        ...
        >
          ...
          >
            <div className="flex items-center gap-2 text-white/90 mb-3 backdrop-blur-sm bg-white/10 w-fit px-3 py-1 rounded-full border border-white/10">
    ...
    return (
      <>
        ...
        >
          ...
          >
            <div className="p-5">
              <span className="text-[10px] font-bold tracking-widest uppercase text-gray-600 dark:text-gray-400 mb-2 block">
                {categoryLabel}
              </span>
      ...
      <>
        ...
        >
          ...
          <div className="w-1/2 p-12 flex flex-col justify-center">
            ...
            <h3 className="text-3xl font-medium text-gray-900 dark:text-white mb-4 group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors">
              {title}
            </h3>
            {description && (
              <p className="text-gray-600 dark:text-gray-400 font-light leading-relaxed max-w-lg mb-6">
                {description}
              </p>
            )}
            <Link
    ...
    >
      <Link href={link} className="flex h-full flex-col">
        ...
        <div className="flex flex-1 flex-col p-5">
          {categoryLabel && (
            <span className="w-fit rounded-full bg-gray-100 px-3 py-1 text-xs font-medium uppercase tracking-wide text-gray-700 dark:bg-white/10 dark:text-gray-300">
              {categoryLabel}
            </span>
          )}
          <h2 className="mt-3 text-xl font-semibold leading-snug text-gray-900 transition-colors duration-300 line-clamp-2 group-hover:text-gray-600 dark:text-white dark:group-hover:text-gray-300">
            {title}
          </h2>
          {description && (
            <p className="mt-2 text-sm text-gray-600 line-clamp-2 dark:text-gray-400">
          ...
          <time className="mt-auto pt-3 text-xs text-gray-500 dark:text-gray-500">
            {formattedDate}
          </time>
        </div>
      </Link>
