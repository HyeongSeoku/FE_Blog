...
const CodeBlock = ({ children }: CodeBlockProps) => {
  ...
  return (
    <div className="relative group">
      ...
      <button
        onClick={handleCopy}
        className="absolute top-2 right-2 p-1 bg-gray-700 text-white rounded opacity-0 group-hover:opacity-100 flex items-center justify-center w-20 h-8 transition-opacity duration-300"
      >
        <span
